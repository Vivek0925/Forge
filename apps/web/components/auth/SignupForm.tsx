      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            className={`h-11 rounded-[var(--radius-sm)] border bg-surface px-4 text-[14px] text-text placeholder:text-text-secondary/70 outline-none transition-colors focus:border-primary ${
              passwordsMismatch ? "border-red-400" : "border-border"
            }`}
          />
          {passwordsMismatch && (
        ...
        <label className="mt-1 flex items-start gap-2.5 text-[12.5px] leading-relaxed text-text-secondary">
          <input
            type="checkbox"
            required
            checked={agreed}
